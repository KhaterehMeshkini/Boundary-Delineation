        ...
        for layer in resnet_layers:
            if isinstance(layer, supported_layers):
                if isinstance(layer, nn.Conv2d):
                    ...
                    expanded_weights = original_weights.repeat(1, 2, 1, 1)[:, :, :, :]  # Shape: (out_channels, 10, H, W)
...
class DynamicAttentionUNet3D(nn.Module):
    def __init__(self, in_channels, num_classes):
        ...
        #self.collapse4 = nn.Conv3d(16, 32, kernel_size=(2, 1, 1))
    ...
    def forward(self, data):
        ...
        B, C, D, H, W = x.shape
        x_out = x.view(B, C * D, H, W)              # (B, 32, 128, 128)
